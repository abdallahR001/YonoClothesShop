...
namespace YonoClothesShop.Migrations
{
    ...
    [Migration("20250505222421_addAdminsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YonoClothesShop.Models.Admin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YonoClothesShop.Models.Cart", b =>
                {
                    b.HasOne("YonoClothesShop.Models.User", null)
                        .WithOne("cart")
                        .HasForeignKey("YonoClothesShop.Models.Cart", "UserId")
            ...
            modelBuilder.Entity("YonoClothesShop.Models.CartItem", b =>
                {
                    b.HasOne("YonoClothesShop.Models.Cart", "cart")
                        .WithMany("cartItems")
            ...
            modelBuilder.Entity("YonoClothesShop.Models.Inventory", b =>
                {
                    b.HasOne("YonoClothesShop.Models.Category", "category")
                        .WithMany()
            ...
            modelBuilder.Entity("YonoClothesShop.Models.OrderItem", b =>
                {
                    b.HasOne("YonoClothesShop.Models.Order", "order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("YonoClothesShop.Models.RefreshToken", b =>
                {
                    b.HasOne("YonoClothesShop.Models.User", "user")
                        .WithMany()
            ...
            modelBuilder.Entity("YonoClothesShop.Models.Review", b =>
                {
                    b.HasOne("YonoClothesShop.Models.Product", "product")
                        .WithMany("reviews")
